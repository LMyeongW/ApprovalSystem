...
<script>
	...
	function reviewWaitList(num){
		...
		$.ajax({
			...
			url : '/mtsystem/reviewWaitList.do',
			type : 'get',
			dateType :'json',
			data : {
				"USER_NUM" : usernum,
			...
			success : function(result){
				...
				var data = result.data.reviewlist;
				var count = result.data.reviewlistCount;
				...
				if(paging.prev){
					...
					page += '<a href="javascript:reviewWaitList(' + startPageNum +')" id="prev"><span></span><span></span></a>';
				...
				for(var num = paging.startPageNum; num <= paging.endPageNum; num++ ){
					if(select == num){
						...
						page += '<span class="point"><a href="javascript:reviewWaitList(' + num + ')">' + num + '</a></span>';
						page +=	'</span>';
					}
					
					if(select != num){
						page += '<span class="numPadding">';
						page += '<span class="noPoint"><a href="javascript:reviewWaitList(' + num + ')">' + num + '</a></span>';
						page +=	'</span>';
					}
				}
				...
				if(paging.next){
					...
					page +=	'<a href="javascript:reviewWaitList(' + endPageNum +')" id="next"><span></span><span></span></a>';
